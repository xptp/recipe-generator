...
Это full-stack веб-приложение, которое позволяет пользователям регистрироваться,  генерировать рецепты по списку ингредиентов с помощью искусственного интеллекта. Проект построен модели T5, модель простенькая, хотел попробовать интеграцию моделей, рассчитывать на вкусный рецепт не стоит, может предложить смузи из гречки.
